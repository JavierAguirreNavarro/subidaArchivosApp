    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white">
                <h1 class="card-title">Lista de Fotos</h1>
            </div>
            <div class="card-body">
                <a href="{{ route('subir.create') }}" class="btn btn-success mb-3">Añadir Imagen</a>
                @if($subirs->isEmpty())
                    <div class="alert alert-warning" role="alert">
                        No hay imágenes subidas. <a href="{{ route('subir.create') }}" class="alert-link">Subir una imagen</a>
                    </div>
                @else
